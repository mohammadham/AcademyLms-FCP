...
<?php $instructor_details = $this->user_model->get_all_user($FCP['user_id'])->row_array(); ?>
            ...
            <div class="invoice-dec">
                <div class="invoice-bill--scroll-bar">
                    <table class="table">
                        ...
                        <tr>
                            <th class="pe-5" scope="col"><h6><?php echo get_phrase('FCP'); ?></h6></th>
                        ...
                        <tbody>
                            <tr>
                                <th scope="row"><p><?php echo $FCP['title']; ?></p></th>
