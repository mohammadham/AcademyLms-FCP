        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row justify-content-md-center">
                    <div class="col-xl-6">
                        <form class="form-inline" action="<?php echo site_url('addons/FCP_manager/payment_history/instructor_revenue/filter_by_date_range') ?>" method="get">
                            <div class="col-xl-10">
                    ...
                    <table id="basic-datatable" class="table table-striped table-centered mb-0">
                        ...
                        <tbody>
                            <?php foreach ($payment_history as $payment) :
                                ...
                                $FCP_details = $this->db->get_where('FCP', array('FCP_id' => $payment['FCP_id']))->row_array(); ?>
                                <tr class="gradeU">
                                    <td>
                                        <a href="<?php echo site_url('FCP/FCP_details/'.rawurlencode(slugify($FCP_details['title'])).'/'.$FCP_details['FCP_id']) ?>" target="_blank"><?php echo $FCP_details['title']; ?></a><br>
                                        <small class="text-muted"><?php echo date('d M Y', $FCP_details['added_date']); ?></small>
                                    </td>
