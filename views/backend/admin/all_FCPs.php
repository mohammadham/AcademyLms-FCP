                                    ...
                                    <td>
                                        <div class="dropright dropright">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('addons/FCP_manager/FCP/status/' . $FCP['FCP_id']); ?>');">
                                                	<?php if($FCP['is_active'] == 1){echo get_phrase('mark_as_pending'); }else{ echo get_phrase('activate'); } ?>
                                                </a></li>
